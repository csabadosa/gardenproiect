...
export const SECTIONS = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: "waste-basket-1400", name: "Square Roofed Waste Basket", code: "GPWB03", desc: MAT, dims: "50 × 50 · Height 120 cm", seed: 1400 },
  ...
  },
  {
    ...
    products: [
      { id: "bus-stop-bm02", name: "Bus Stop Shelter", code: "GPSS01", desc: MAT, dims: "470 × 220 · Height 250 cm", seed: 42000 },
      { id: "bus-stop-bm01", name: "Bus Stop Shelter", code: "GPSS02", desc: MAT, dims: "470 × 220 · Height 250 cm", seed: 42000 },
  ...
  },
  {
    ...
    products: [
      ...
      { id: "swing-frame-lp01", name: "Swing Frame", code: "GPPS01", desc: "Wood (oak, acacia) and metal with special paint. Available in selected colors. Recommended for private gardens.", seed: 3750 },
      { id: "swing-frame-sw04", name: "Seesaw", code: "GPPS03", desc: MAT, seed: 3750 },
  ...
  },
  {
    ...
    products: [
      { id: "mini-playground", name: "Mini Playground Complex – Castle Type", code: "GPLP01", desc: MAT, dims: "Width 480 × Height 240 cm", seed: 16500 },
